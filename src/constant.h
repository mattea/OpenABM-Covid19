...
#define N_INFECTIOUSNESS_BUCKETS 3
...
extern const int INFECTIOUSNESS_BUCKETS[N_INFECTIOUSNESS_BUCKETS];
...
#define N_NETWORK_INTERACTION_TYPES N_INTERACTION_TYPES - N_HOSPITAL_INTERACTION_TYPES - 1
